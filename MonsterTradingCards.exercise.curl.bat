...
echo.
REM curl -X POST http://localhost:10001/users --header "Content-Type: application/json" -d "{\"Username\":\"admin\",    \"Password\":\"istrator\"}"
REM echo.
...
echo.
REM curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"admin\",    \"Password\":\"istrator\"}"
REM echo.
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"Leo\", \"Password\":\"123\"}"
echo.
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"Pascal\", \"Password\":\"123\"}"
echo.
...
REM --------------------------------------------------
REM echo 3) create packages (done by "admin")
...
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo.
REM echo should fail (no package):
REM curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
REM echo.
REM echo.

REM --------------------------------------------------
REM echo 6) add new packages
...
REM --------------------------------------------------
echo 7) acquire packages altenhof (newly created)
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo.
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo.
...
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer Leo-mtcgToken" -d "{\"ce1f0c7c63534f87be3dd64884fef459\", \"73c94e2b91e145dfabd1e89c6e36d3eb\", \"c353685c9ab04822a321ab7f389dfc50\",\"47fa626985d24d2c98a64fbbb8a2be0e\"}"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Bearer Leo-mtcgToken"
echo.
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer Leo-mtcgToken" -d "{\"20d76bf50a424d54931e5c26279fff17\", \"dbc9bbe0363f47c1b8a92730661648a9\", \"551c5d6ab317428085ade80aa9cadad4\", \"f69e3837e1e64c09b164b6a34416d5c1\"}"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Bearer Leo-mtcgToken"
echo.
echo.
echo should fail and show original from before:
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d "{\"6eeb5f64e2954ca98c2c259cbdd07ae6\", \"d83b9366f4f24acbb4b211fd3283c622\", \"b6d4095c6ad446c5bb8692e71ba9da53\",\"f5514f33b719440f9d9f5e01ce6ad901\"}"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Bearer kienboec-mtcgToken"
echo.
echo.
echo should fail ... only 3 cards set
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer Leo-mtcgToken" -d "{\"6eeb5f64e2954ca98c2c259cbdd07ae6\", \"d83b9366f4f24acbb4b211fd3283c622\", \"b6d4095c6ad446c5bb8692e71ba9da53\"}"
echo.
...
curl -X GET http://localhost:10001/scoreboard --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X GET http://localhost:10001/scoreboardWins --header "Authorization: Bearer kienboec-mtcgToken"
echo.
echo.
...
curl -X GET http://localhost:10001/tradings --header "Authorization: Bearer Leo-mtcgToken"
echo.
echo create trading deal
curl -X POST http://localhost:10001/tradings --header "Content-Type: application/json" --header "Authorization: Bearer Leo-mtcgToken" -d "{\"Id\": \"6cd85277-4590-49d4-b0cf-ba0a921faad0\", \"CardToTrade\": \"ba76a49cf7e54b86b24b8028fc9fe1e2\", \"Type\": \"Monster\", \"MinDmg\": 15}"
echo.
echo check trading deals
...
curl -X DELETE http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Authorization: Bearer Leo-mtcgToken"
echo.
echo.
...
curl -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Bearer Leo-mtcgToken" -d "\"ba76a49cf7e54b86b24b8028fc9fe1e2\""
echo.
echo try to trade 
echo.
curl -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Bearer Pascal-mtcgToken" -d "\"6b7ec68b9d744b21a1954203c76d79fa\""
echo.
curl -X GET http://localhost:10001/tradings --header "Authorization: Bearer Leo-mtcgToken"
echo.
curl -X GET http://localhost:10001/tradings --header "Authorization: Bearer Pascal-mtcgToken"
echo.
echo.

echo 22) trade back
echo create trading deal
curl -X POST http://localhost:10001/tradings --header "Content-Type: application/json" --header "Authorization: Bearer Pascal-mtcgToken" -d "{\"Id\": \"6cd85277-4590-49d4-b0cf-ba0a921faad0\", \"CardToTrade\": \"ba76a49cf7e54b86b24b8028fc9fe1e2\", \"Type\": \"Monster\", \"MinDmg\": 15}"
echo check trading deals
curl -X GET http://localhost:10001/tradings  --header "Authorization: Bearer kienboec-mtcgToken"
echo.
echo try to trade 
echo.
curl -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Bearer Leo-mtcgToken" -d "\"6b7ec68b9d744b21a1954203c76d79fa\""
echo.
echo check trading deals
curl -X GET http://localhost:10001/tradings  --header "Authorization: Bearer kienboec-mtcgToken"
echo.
...
ping localhost -n 36000 >NUL 2>NUL
@echo on
